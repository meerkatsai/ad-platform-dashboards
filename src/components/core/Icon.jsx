...
/* Lucide icons (ISC licence), path data inlined so glyphs inherit currentColor and render offline.
   Add new names by copying the path data from lucide.dev — never hand-draw. */
const P = {
